        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="introduct_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Tiêu Đề" FieldName="introduce_title" HeaderStyle-HorizontalAlign="Center" Width="20%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Tóm tắt" FieldName="introduce_summary" HeaderStyle-HorizontalAlign="Center" Width="30%"></dx:GridViewDataColumn>
